...
//
//        TrajectorySequence preloadThird = preload(startRedWareHousePose, RedWarehouseAuto.RedWarehouseShippingHub.THIRD_LEVEL);
//        TrajectorySequence preloadSecond = preload(startRedWareHousePose, RedWarehouseAuto.RedWarehouseShippingHub.SECOND_LEVEL);
//        TrajectorySequence preloadFirst = preload(startRedWareHousePose, RedWarehouseAuto.RedWarehouseShippingHub.FIRST_LEVEL);
//
...
//                })
//                .splineToSplineHeading(BlueWarehouseShippingHub.THIRD_LEVEL.goTo, Math.toRadians(115.0))
//                .setReversed(false)
//                .build();
//    }
//
